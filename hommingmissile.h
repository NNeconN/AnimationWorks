...
class HommingMissileMgr {
private:
	std::vector<std::unique_ptr<HomingMissile>>	m_hominggmissiles;
public:
	// 弾発射
	void Fire(	DirectX::XMFLOAT4X4 mtx,		// 飛行機の姿勢
				DirectX::XMFLOAT3 target);		// 目標物

	void Update(DirectX::XMFLOAT4X4 mtx,		// 飛行機の姿勢
				DirectX::XMFLOAT3 target);		// 目標物
